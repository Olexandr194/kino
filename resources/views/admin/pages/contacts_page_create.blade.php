...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <form action="{{ route('admin.pages.contact_page_store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-12 ml-2">
                            ...
                            <div class="form-group">
                                <div class="d-flex">
                                    <div class="col-md-2">
                                        <label>Координати для карти:</label>
                                    </div>
                                    <div class="col-md-4 mr-5">
            ...
            <div class="form-group mt-5 ">
                <div class="text-center">
                    <input type="submit" class="btn btn-dark" value="Додати" style="width: 150px">
                </div>
            </div>
        </form>
    </div>
